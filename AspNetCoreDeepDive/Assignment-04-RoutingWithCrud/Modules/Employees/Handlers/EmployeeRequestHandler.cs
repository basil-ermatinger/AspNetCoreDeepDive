using Assignment_04_RoutingWithCrud.Modules.Employees.Models;
using Assignment_04_RoutingWithCrud.Modules.Employees.Repositories;
using System.Text.Json;

namespace Assignment_04_RoutingWithCrud.Modules.Employees.Handlers
{
	public static class EmployeeRequestHandler
	{
		...
		public static async Task HandleGetEmployeeById(HttpContext context)
		{
			context.Response.ContentType = "text/html";
		...
		public static async Task HandleGetPositionById(HttpContext context)
		{
			context.Response.ContentType = "text/html";
			...
			if(employee is not null)
			{
				await context.Response.WriteAsync($"{employee.Position}<br/>");
			}
			else
			{
				context.Response.StatusCode = 404;
